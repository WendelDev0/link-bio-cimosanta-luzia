      ...
      <section className="bio-panel" aria-label="Links de contato da CIMO Santa Luzia">
        ...
        <div className="quick-actions" aria-label="Redes sociais">
          <a
            ...
            href="https://www.instagram.com/cimosantaluzia"
            target="_blank"
            rel="noreferrer"
          ...
          {cities.map((city) => (
            ...
            >
              ...
              <span className="city-copy">
                ...
                <span className="city-phone">{formatPhone(city.phone)}</span>
              </span>
        ...
        <div className="info-band">
          <div>
            <MapPin size={16} />
            <span>3 unidades em Sergipe</span>
          </div>
          <div>
          ...
          <div>
            <Phone size={16} />
            <span>Atendimento direto na unidade</span>
          </div>
        </div>
      </section>
    </main>
